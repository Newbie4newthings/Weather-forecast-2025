...
# ================================
API_KEY = "d51acf7751a629f82ae45085bd7e1acf"
...
def train_rain_model(x, y):
  ...
  print("Mean SquaredError For Rain Model")
...
def weather_view(request):
    if request.method == 'POST':
        ...
        x_pres, y_pres = prepare_regression_data(historical_data, 'Pressure')
        temp_model = train_regression_model(x_temp, y_temp)
        hum_model = train_regression_model(x_hum, y_hum)
        pres_model = train_regression_model(x_pres, y_pres)
        ...
        future_pres = predict_future(pres_model, current_weather['pressure'])
